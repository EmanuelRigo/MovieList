  ...
  return (
    <>
      <select
        ...
        className="w-full text-sm bg-transparent text-neutral-900 dark:text-neutral-100 outline-none rounded-lg justify-center items-center p-3 border-2 border-neutral-800"
      >
