...
const GenreFilter = () => {
  ...
  return (
    <select
      ...
      className=" w-full lg:w-auto text-sm bg-transparent  text-neutral-900 dark:text-neutral-100 outline-none rounded-lg justify-center items-center p-2 dark:border-neutral-800"
    >
      <option
        value=""
