...
export const AddMovie = () => {
  ...
  return (
    <div className="h-screen w-screen flex items-center">
      <div className="container rounded-lg bg-neutral-100 dark:bg-neutral-900 p-4 mx-auto h-full lg:h-5/6 flex flex-col items-start lg:items-center justify-center">
        <div className="flex justify-between align-center w-full pb-6">
          <form
            onSubmit={handleSubmit}
            className="flex w-4/5 lg:w-2/4 bg-white dark:bg-neutral-800 items-center rounded-lg overflow-hidden shadow-sm"
          >
            <input
              type="text"
              placeholder="Busca la pelicula a agregar"
              className="w-full py-3 px-4 focus:outline-none dark:bg-neutral-700 dark:text-neutral-200"
              value={busqueda}
          ...
          <Link
            className="p-4 bg-orange-500 rounded-lg dark:bg-orange-600"
            href="/"
          >
            volver
          </Link>
