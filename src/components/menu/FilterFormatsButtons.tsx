  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between bg-neutral-100 dark:bg-transparent lg:dark:bg-neutral-800 lg:rounded-lg px-4">
        <button
          className={`text-black rounded-lg dark:text-neutral-200 hover:text-blue-500 dark:hover:text-orange-400 pe-4 ${
        ...
        >
          <svg
            ...
            viewBox="0 0 300 200"
            fill="currentColor"
            className="w-12 h-12 text-current flex items-center"
          >
            <g
              transform="translate(0.000000,200.000000) scale(0.100000,-0.100000)"
              stroke="none"
            >
              <path d="M350 1000 l0 -580 1150 0 1150 0 0 580 0 580 -1150 0 -1150 0 0 -580z m2260 0 l0 -540 -1110 0 -1110 0 0 540 0 540 1110 0 1110 0 0 -540z" />
              <path d="M480 1453 c1 -4 52 -208 114 -453 l113 -445 106 -3 c59 -1 107 1 107 5 0 5 -4 23 -9 41 -8 26 6 104 80 430 49 218 92 405 95 415 5 15 -2 17 -53 17 l-59 0 0 -72 c0 -52 -15 -139 -52 -298 -29 -124 -56 -234 -60 -244 -6 -14 -32 72 -88 295 l-79 314 -107 3 c-60 1 -108 -1 -108 -5z" />
              <path d="M1170 1157 c0 -251 -3 -307 -15 -323 -18 -24 -19 -34 0 -34 12 0 15 -23 17 -122 l3 -123 92 -3 92 -3 3 123 3 123 80 5 c49 3 93 12 113 23 l32 18 0 -146 0 -145 95 0 95 0 0 455 0 455 -95 0 -95 0 0 -290 0 -290 -115 0 -115 0 0 290 0 290 -95 0 -95 0 0 -303z" />
              <path d="M2095 1446 c-150 -47 -235 -144 -235 -268 0 -138 65 -203 265 -263 103 -31 157 -62 185 -108 25 -41 25 -73 0 -114 -34 -57 -60 -63 -250 -63 -93 0 -170 -2 -170 -5 0 -2 8 -21 17 -40 l17 -36 196 3 c189 3 197 4 245 30 124 66 179 185 144 313 -25 91 -93 140 -244 175 -102 24 -153 48 -189 90 -52 62 -26 159 53 200 35 18 59 20 199 20 l158 0 17 35 c9 20 17 38 17 40 0 12 -387 3 -425 -9z" />
            </g>
          </svg>
        </button>
        <button
          className={`text-black rounded-lg dark:text-neutral-200 hover:text-blue-500 dark:hover:text-orange-400 px-4 ${
        ...
        >
          <svg
            ...
            viewBox="0 0 450 430"
            fill="currentColor"
            className="w-14 h-12 text-current "
          >
            <g
