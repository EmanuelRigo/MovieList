...
const OrderListButtons = () => {
  ...
  return (
    <div className="flex justify-between bg-neutral-100 dark:bg-transparent lg:dark:bg-neutral-800 rounded-lg  text-black  dark:text-neutral-200 text-3xl lg:text-xl 2xl:text-3xl 2xl:p-4">
      <button
