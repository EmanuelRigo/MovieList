...
export default function Home() {
  ...
  return (
    <div className="h-screen w-screen flex items-center">
      <div
        className="container md:max-h-[956px] rounded-xl bg-neutral-300 dark:bg-neutral-900 mx-auto grid grid-cols-1 h-full 2xl:h-5/6 overflow-auto md-grid-template gap-4 p-4"
      >
