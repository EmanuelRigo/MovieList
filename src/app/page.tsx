...
export default async function Home() {
  ...
  return (
    <div className="h-svh w-screen flex flex-col overflow-hidden justify-center">
      <div className="w-full h-full 1-5xl:max-h-[956px] 1-5xl:h-5/6 lg:w-full 1-5xl:container rounded-xl bg-neutral-300 dark:lg:bg-background-secondary dark:bg-transparent mx-auto grid grid-cols-1 md-grid-template md:grid-rows-[auto_1fr] gap-0 p-4 md:p-0">
        ...
        <div className="md:col-span-3 grid grid-cols-1 md-grid-template gap-4 min-h-0 h-full">
          ...
          {/* Lista de películas */}
          <div className="hidden lg:block h-full w-full overflow-auto min-h-0 md:pt-0">
