...
console.log(uri, "//////////////////"); // Cambiado a la variable de entorno
...
const Page = () => {
  ...
  return (
    <div className="h-screen w-screen flex items-center">
      <div className="container rounded-lg bg-neutral-100 dark:bg-neutral-900 mx-auto flex w-full h-full lg:h-5/6 overflow-auto">
        ...
        <div className="text-black dark:text-white p-4 flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center mb-4">
              <h1 className="text-2xl">{pelicula.title}</h1>
              <Link
                href="/add-movie"
                className="p-4 bg-orange-500 rounded-lg text-black dark:bg-orange-600 dark:text-white"
              >
                Volver
              </Link>
            </div>
          ...
          <div>
            ...
            <button
              ...
              className="p-5 bg-orange-500 rounded-lg w-full text-black dark:text-white"
            >
              Agregar película
            </button>
          </div>
